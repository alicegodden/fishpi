# Title: FishPi
# Subtitle: Benchmarking memory useage pycharm desktop use
...
print(f"Opening FishPi GUI {memory_usage:.2f} MB of memory.")
...
def is_complementary(piRNA_substring, TE_sequence):
    ...
    process = psutil.Process(os.getpid())
    memory_usage = process.memory_info().rss / 1024 ** 2  # Convert bytes to MB
    print(f"is_complementary took {memory_usage:.2f} MB of memory.")
...
def get_complementary_base(base):
    ...
    process = psutil.Process(os.getpid())
    memory_usage = process.memory_info().rss / 1024 ** 2  # Convert bytes to MB
    print(f"get_complementary took {memory_usage:.2f} MB of memory.")
...
def classify_te_type(TE_name):
    ...
    process = psutil.Process(os.getpid())
    memory_usage = process.memory_info().rss / 1024 ** 2  # Convert bytes to MB
    print(f"classify_te_type took {memory_usage:.2f} MB of memory.")
...
def analyse_sequence():
    ...
    process = psutil.Process(os.getpid())
    memory_usage = process.memory_info().rss / 1024 ** 2  # Convert bytes to MB
    print(f"analyse_sequence took {memory_usage:.2f} MB of memory.")
...
def classify_te_type(TE_name):
    ...
    process = psutil.Process(os.getpid())
    memory_usage = process.memory_info().rss / 1024 ** 2  # Convert bytes to MB
    print(f"To classifiy complementary TEs and generate bar chart took {memory_usage:.2f} MB of memory.")
...
def plot_te_chromosomal_locations():
    ...
    process = psutil.Process(os.getpid())
    memory_usage = process.memory_info().rss / 1024 ** 2  # Convert bytes to MB
    print(f"Plotting TE locations in genome took {memory_usage:.2f} MB of memory.")
...
def export_bar_chart():
    ...
    if filename:
        ...
        process = psutil.Process(os.getpid())
        memory_usage = process.memory_info().rss / 1024 ** 2  # Convert bytes to MB
        print(f"Exporting the bar chart took {memory_usage:.2f} MB of memory.")
...
def upload_pirna_file():
    ...
    if file_path:
        ...
        process = psutil.Process(os.getpid())
        memory_usage = process.memory_info().rss / 1024 ** 2  # Convert bytes to MB
        print(f"Uploading entire D.rerio piRNA database to analyse took {memory_usage:.2f} MB of memory.")
